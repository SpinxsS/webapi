...
import MovieRowSign from '../components/MovieRowSign';
import Favoritos from '../components/Favoritos';

/** Pagina por default del home */
class HomeSign extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
        ...
        <div className='container-flex'>
          <div className='col-12 anchor' id='estrenos'>
            ...
            <div className='row'>
              ...
              {!loading && premiere.map(movie => <MovieRowSign movie={movie} key={movie.id} />)}
          ...
          <div className='col-12 anchor' id='populares'>
            ...
            <div className='row'>
              {!loading && trending.map(movie => <MovieRowSign movie={movie} key={movie.id} />)}
              {loading && <div className='col-12 text-center'> <p>Cargando información...</p> </div>}
